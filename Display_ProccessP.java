 ...
 * @author DELL
 */
public class Display_ProccessP extends Panel{
    private List<Process> processes;

    public Display_ProccessP(List<Process> processes) {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Priority", startX + 5 * colWidth, startY);

        g.drawLine(startX, startY + 10, startX + 6 * colWidth, startY + 10);
        ...
        for (Process process : processes) {
            ...
            g.drawString(String.valueOf(process.getPriority()), startX + 5 * colWidth, yPos);
            yPos += rowHeight;
        }
    }
